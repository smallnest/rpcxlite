...
import (
	...
	"github.com/smallnest/rpcxlite/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/smallnest/rpcxlite/server"`)
	fmt.Fprintln(w, `  "github.com/smallnest/rpcxlite/serverplugin"`)
